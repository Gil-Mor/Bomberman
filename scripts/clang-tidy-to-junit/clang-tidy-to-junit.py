...
{htmldata}
    ...
    def process_error(self, error_array):
        ...
        # Clang-tidy outputs duplicate errors where the difference is that one of the errors
        # have clang warning about --coverage compilation argument not being used.
        if "warning: argument unused during compilation:" in error.description:
            return
