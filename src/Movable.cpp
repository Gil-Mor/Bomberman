...
//    Posb nextPosb = _posb;
//
//    if (_posOffset.x < -TILE_SIZE.x/2) {
//        --nextPosb.j;
//    }
//
//    else if (_posOffset.x > TILE_SIZE.x/2) {
//        ++nextPosb.j;
//    }
//
//    else if (_posOffset.y < -TILE_SIZE.y/2) {
//        --nextPosb.i;
//    }
//
//    else if (_posOffset.y > TILE_SIZE.y / 2) {
...
//    Posb nextPosb = _posb;
//
//    if (movement.x < -TILE_SIZE.x / 2) {
//        --nextPosb.j;
//    }
//
//    else if (movement.x > TILE_SIZE.x / 2) {
//        ++nextPosb.j;
//    }
//
//    else if (movement.y < -TILE_SIZE.y / 2) {
//        --nextPosb.i;
//    }
//
//    else if (movement.y > TILE_SIZE.y / 2) {
...
//    }
//
//    if (_posOffset.y <= -TILE_SIZE.y || _posOffset.y >= TILE_SIZE.y) {
//        _posOffset.y = 0;
//    }
//
//    _posOffset = -_posOffset;
//
//    _posf = nextPos + _posOffset;
//
