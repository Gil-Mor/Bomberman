...
// linger 5 seconds after all the players / enemies have died
const float END_GAME_DURATION = 5;

Level::Level(ControllerProxy& controller) : _controller(controller), _levelProxy(*this), _board(_levelProxy)
{
