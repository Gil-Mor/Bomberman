...
void BoardBuffer::update(
    board3d& board, PosfMap& posfMap, DynamitesList& dynamites, ExplosionsList& explosions, AIMap& aiMap)
{
...
void BoardBuffer::addToBoard(board3d& board, DynamitesList& dynamites, ExplosionsList& explosions)
{
...
void BoardBuffer::removeFromBoard(
    board3d& board, PosfMap& posfMap, DynamitesList& dynamites, ExplosionsList& explosions, AIMap& aiMap)
{
